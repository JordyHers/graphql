...
//___________________. AUTHOR TYPE
...
// We need to create a RootueryType to define the type of data we want to request
const RootQueryType = new GraphQLObjectType({
  name: "Query",
  //We need to give a description
  description: "Root Query",
  fields: () => ({
    /// We want to return a list of book
    book: {
      type: BookType,
...
// https://www.youtube.com/watch?v=ZQL7tL2S0oQ 19:21
